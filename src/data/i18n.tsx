...
const I18N: Record<Lang, Record<string, string | string[]>> = {
  lo: {
    ...
    pay_full6:'400,000,000 ₭/1,000 ₭', pay_d5:'~40,000,000 ₭/1,000 ₭', pay_d4:'~5,000,000 ₭/1,000 ₭',
    pay_d3:'~500,000 ₭/1,000 ₭', pay_d2:'~60,000 ₭/1,000 ₭', pay_d1:'~5,000 ₭/1,000 ₭',
    riskTitle:'ສ່ຽງເລກ — ຕັ້ງຄ້າລ່ວງໜ້າ',
    riskHint:'ຕັ້ງເລກ ແລະ ຈຳນວນເງິນໄວ້ ແອັບຈະກວດຕອນອອກຜົນ', goBuyBtn:'ຕັ້ງເລກ / ສຸ່ມເລກ / ຊື້ຫວຍ',
    betNum:'ເລກທີ່ຈະສ່ຽງ (1–6 ໂຕ)', betAmount:'ຈຳນວນ (ກີບ)', betDraw:'ງວດ',
    addBet:'ຕັ້ງເລກສ່ຽງ',
    betDup:'ມີເລກນີ້ໃນງວດນີ້ແລ້ວ', betBad:'ໃສ່ເລກ ແລະ ຈຳນວນໃຫ້ຖືກ',
    checkNow:'🔄 ກວດຕອນນີ້', stakeTotal:'ລວມ: {v} ກີບ',
    noResultYet:'ຍັງບໍ່ອອກຜົນ',
    inputPh2:'ເຊັ່ນ 607595 ຫຼື 95',
    autoNote:'ກວດຄ່ານີ້ ເມື່ອງວດທີ່ຕັ້ງໄວ້ ໄດ້ອອກຜົນແລ້ວ',
    maxStakeHint:'ສູງສຸດ {max} ກີບ ສຳລັບເລກ {n} ໂຕ',
    betMaxExceeded:'ຈຳນວນເງິນເກີນກຳນົດ — ເລກ {n} ໂຕ ໃສ່ໄດ້ສູງສຸດ {max} ກີບ',
    riskRandomBtn:'ສຸ່ມເລກ', chooseDigits:'ເລືອກຈຳນວນຫຼັກ:',
    fixDigitsLabel:'ກຳນົດເລກ (ຈະໃສ່ ຫຼື ບໍ່ໃສ່ກໍ່ໄດ້):',
    randomQtyLabel:'ຈຳນວນເລກທີ່ຈະສ່ຽງ', randomQtyNote:'ໃສ່ໄດ້ 1–1,000 ເລກ',
    cancelBtn:'ຍົກເລີກ', confirmBtn:'ຢືນຢັນ',
    randomAdded:'ຕັ້ງເລກສຸ່ມແລ້ວ {n} ເລກ!', randomBad:'ກະລຸນາໃສ່ຈຳນວນເລກ ແລະ ຈຳນວນເງິນໃຫ້ຖືກຕ້ອງ',
    cartTitle:'ລາຍການທີ່ຈະຊື້', cartEmptyWarn:'ຍັງບໍ່ມີເລກໃນລາຍການ', confirmPurchaseBtn:'ຢືນຢັນການຊື້',
    dateChangeClears:'ປ່ຽນງວດຈະລ້າງລາຍການທີ່ຍັງບໍ່ຢືນຢັນ ຕ້ອງການສືບຕໍ່ບໍ?',
    purchaseHistory:'ປະຫວັດການຊື້', emptyPurchases:'ຍັງບໍ່ມີປະຫວັດການຊື້',
    purchaseHistoryDesc:'ໃບບິນ ແລະ ຜົນທີ່ຊື້ໄວ້', resultsHistoryTitle:'ປະຫວັດຜົນຫວຍ',
    resultsHistoryDesc:'ຜົນຫວຍທຸກງວດທີ່ອອກແລ້ວ',
    myBetsTitle:'ເລກທີ່ສ່ຽງໄວ້',
    drawRoundLabel:'ງວດວັນທີ', billNo:'ເລກບິນ', refNo:'ເລກອ້າງອີງ', channel:'ຊ່ອງທາງ',
    totalCount:'ຈຳນວນທັງໝົດ', numbersUnit:'ເລກ', totalAmountLabel:'ຍອດເງິນທັງໝົດ',
    purchaseConfirmed:'ຊື້ສຳເລັດແລ້ວ', demoNote:'ໃບບິນນີ້ເປັນຕົວຢ່າງເທົ່ານັ້ນ ບໍ່ມີການຊຳລະເງິນຈິງ',
    demoChannel:'ແອັບ ກ້ອຍເຫຼົ້າ (ຕົວຢ່າງ)', moreNumbers:'ແລະ ອີກ {n} ເລກ',
    checkSummary:'ກວດແລ້ວ: ຖືກ {win} ເລກ (+{amt} ກີບ) · ບໍ່ຖືກ {lose} ເລກ',
    winCongrats:'ຂໍສະແດງຄວາມຍິນດີ', winRibbon:'ຖືກເລກ!', winTotalLabel:'ຍອດເງິນທີ່ໄດ້ຮັບ',
    winChecked:'ກວດສຳເລັດ', winJackpotCount:'ຖືກແຈັກພັອດ', winNumbersLabel:'ເລກທີ່ຖືກ',
    billDetails:'ລາຍລະອຽດບິນ', viewDetailsBtn:'ເບິ່ງລາຍລະອຽດ',
    statusPending:'⏳ ລໍຖ້າຜົນ', statusWinCount:'✅ ຖືກ {n} ເລກ', statusAllLose:'❌ ບໍ່ຖືກ',
  ...
  th: {
    ...
    riskHint:'ตั้งเลขและเงินเอาไว้ก่อน แอปจะตรวจให้เองตอนออกผล', goBuyBtn:'ตั้งเลข / สุ่มเลข / ซื้อหวย',
    betNum:'เลขที่จะเสี่ยง (1–6 หลัก)', betAmount:'จำนวน (กีบ)', betDraw:'งวด',
    addBet:'ตั้งเลขเสี่ยง',
    betDup:'มีเลขนี้ในงวดนี้แล้ว', betBad:'ใส่เลขและจำนวนให้ถูก',
    checkNow:'🔄 ตรวจตอนนี้', stakeTotal:'รวม: {v} กีบ',
    noResultYet:'ยังไม่ออกผล',
    inputPh2:'เช่น 607595 หรือ 95',
    autoNote:'ตรวจค่านี้เมื่องวดที่ตั้งไว้ออกผลแล้ว',
    maxStakeHint:'สูงสุด {max} กีบ สำหรับเลข {n} หลัก',
    betMaxExceeded:'จำนวนเงินเกินกำหนด — เลข {n} หลัก ใส่ได้สูงสุด {max} กีบ',
    riskRandomBtn:'สุ่มเลข', chooseDigits:'เลือกจำนวนหลัก:',
    fixDigitsLabel:'กำหนดเลข (จะใส่หรือไม่ใส่ก็ได้):',
    randomQtyLabel:'จำนวนเลขที่จะเสี่ยง', randomQtyNote:'ใส่ได้ 1–1,000 เลข',
    cancelBtn:'ยกเลิก', confirmBtn:'ยืนยัน',
    randomAdded:'ตั้งเลขสุ่มแล้ว {n} เลข!', randomBad:'กรุณาใส่จำนวนเลขและจำนวนเงินให้ถูกต้อง',
    cartTitle:'รายการที่จะซื้อ', cartEmptyWarn:'ยังไม่มีเลขในรายการ', confirmPurchaseBtn:'ยืนยันการซื้อ',
    dateChangeClears:'เปลี่ยนงวดจะล้างรายการที่ยังไม่ยืนยัน ต้องการดำเนินการต่อหรือไม่?',
    purchaseHistory:'ประวัติการซื้อ', emptyPurchases:'ยังไม่มีประวัติการซื้อ',
    purchaseHistoryDesc:'ใบบิลและผลที่ซื้อไว้', resultsHistoryTitle:'ประวัติผลหวย',
    resultsHistoryDesc:'ผลหวยทุกงวดที่ออกแล้ว',
    myBetsTitle:'เลขที่เสี่ยงไว้',
    drawRoundLabel:'งวดวันที่', billNo:'เลขบิล', refNo:'เลขอ้างอิง', channel:'ช่องทาง',
    totalCount:'จำนวนทั้งหมด', numbersUnit:'เลข', totalAmountLabel:'ยอดเงินทั้งหมด',
    purchaseConfirmed:'ซื้อสำเร็จแล้ว', demoNote:'ใบเสร็จนี้เป็นตัวอย่างเท่านั้น ไม่มีการชำระเงินจริง',
    demoChannel:'แอป ก้อยเหล้า (ตัวอย่าง)', moreNumbers:'และอีก {n} เลข',
    checkSummary:'ตรวจแล้ว: ถูก {win} เลข (+{amt} กีบ) · ไม่ถูก {lose} เลข',
    winCongrats:'ขอแสดงความยินดี', winRibbon:'ถูกเลข!', winTotalLabel:'ยอดเงินที่ได้รับ',
    winChecked:'ตรวจสำเร็จ', winJackpotCount:'ถูกแจ็กพอต', winNumbersLabel:'เลขที่ถูก',
    billDetails:'รายละเอียดบิล', viewDetailsBtn:'ดูรายละเอียด',
    statusPending:'⏳ รอผล', statusWinCount:'✅ ถูก {n} เลข', statusAllLose:'❌ ไม่ถูก',
  ...
  en: {
    ...
    pay_full6:'400,000,000 KIP/1,000 KIP', pay_d5:'~40,000,000 KIP/1,000 KIP', pay_d4:'~5,000,000 KIP/1,000 KIP',
    pay_d3:'~500,000 KIP/1,000 KIP', pay_d2:'~60,000 KIP/1,000 KIP', pay_d1:'~5,000 KIP/1,000 KIP',
    ...
    goBuyBtn:'Set numbers / random / buy',
    betNum:'Number to bet (1–6 digits)', betAmount:'Stake (KIP)', betDraw:'Draw',
    addBet:'Add bet',
    betDup:'This number is already set for that draw', betBad:'Please enter a valid number and stake',
    ...
    maxStakeHint:'Max {max} KIP for a {n}-digit number',
    betMaxExceeded:'Stake too high — a {n}-digit number allows at most {max} KIP',
    riskRandomBtn:'Random', chooseDigits:'Choose digit count:',
    fixDigitsLabel:'Fix digits (optional, leave blank to randomize):',
    randomQtyLabel:'How many numbers', randomQtyNote:'1–1,000 numbers',
    cancelBtn:'Cancel', confirmBtn:'Confirm',
    randomAdded:'Added {n} random bets!', randomBad:'Please enter a valid quantity and stake',
    cartTitle:'Cart', cartEmptyWarn:'Your cart is empty', confirmPurchaseBtn:'Confirm purchase',
    dateChangeClears:'Switching the draw date clears your unconfirmed cart. Continue?',
    purchaseHistory:'Purchase history', emptyPurchases:'No purchases yet',
    purchaseHistoryDesc:'Bills and their results', resultsHistoryTitle:'Lottery results history',
    resultsHistoryDesc:'Every past draw result',
    myBetsTitle:'My bet numbers',
    drawRoundLabel:'Draw date', billNo:'Bill No.', refNo:'Ref No.', channel:'Channel',
    totalCount:'Total count', numbersUnit:'numbers', totalAmountLabel:'Total amount',
    purchaseConfirmed:'Purchase confirmed', demoNote:'This receipt is a demo only — no real payment was made.',
    demoChannel:'KoyLao App (demo)', moreNumbers:'and {n} more',
    checkSummary:'Checked: {win} won (+{amt} KIP) · {lose} lost',
    winCongrats:'Congratulations', winRibbon:'You won!', winTotalLabel:'Total winnings',
    winChecked:'Checked', winJackpotCount:'Jackpot wins', winNumbersLabel:'Winning numbers',
    billDetails:'Bill details', viewDetailsBtn:'View details',
    statusPending:'⏳ Pending', statusWinCount:'✅ {n} won', statusAllLose:'❌ Not won',
